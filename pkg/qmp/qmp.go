...
type executor interface {
	Execute(ctx context.Context, method string, args any) (json.RawMessage, error)
}
...
func New(agent *connect.AgentClient) *Client {
...
func (c *Client) QueryStatus(ctx context.Context) (*VMStatus, error) {
	raw, err := c.agent.Execute(ctx, cmdQueryStatus, nil)
	if err != nil {
		return nil, err
	}
...
func (c *Client) QueryMemory(ctx context.Context) (*MemorySummary, error) {
	raw, err := c.agent.Execute(ctx, cmdQueryMemory, nil)
	if err != nil {
		return nil, err
	}
...
func (c *Client) QueryCPUs(ctx context.Context) ([]CPU, error) {
	raw, err := c.agent.Execute(ctx, cmdQueryCPUs, nil)
	if err != nil {
		return nil, err
	}
...
func (c *Client) QueryBlockStats(ctx context.Context) ([]BlockStat, error) {
	raw, err := c.agent.Execute(ctx, cmdQueryBlockStats, nil)
	if err != nil {
		return nil, err
	}
...
func (c *Client) Reset(ctx context.Context) error {
	_, err := c.agent.Execute(ctx, cmdReset, nil)
	return err
}

// PowerDown shuts down the VM
func (c *Client) PowerDown(ctx context.Context) error {
	_, err := c.agent.Execute(ctx, cmdPowerdown, nil)
	return err
}

// Stop force shut down the VM
func (c *Client) Stop(ctx context.Context) error {
	_, err := c.agent.Execute(ctx, cmdStop, nil)
	return err
}

// Resume starts the VM
func (c *Client) Resume(ctx context.Context) error {
	_, err := c.agent.Execute(ctx, cmdResume, nil)
	return err
...
func (c *Client) QueryCharDev(ctx context.Context) ([]CharDev, error) {
	raw, err := c.agent.Execute(ctx, cmdQueryChardev, nil)
	if err != nil {
		return nil, err
	}
